package com.github.whyrising.composetemplate.app.common.composables
...
import androidx.compose.ui.unit.dp
import com.github.whyrising.composetemplate.ui.theme.MyTheme
...
fun MyApp(
    ...
    MyTheme {
        Scaffold(topBar = { TopBar(title = topBarTitle) }) { innerPadding ->
